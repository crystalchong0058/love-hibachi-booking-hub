...
const MomentsGallery = () => {
  ...
  const moments = [
    ...
    {
      type: 'video',
      src: '/videos/moments/806_1749493142.mp4',
    ...
    {
      type: 'video',
      src: '/videos/moments/784_1748814869.mp4',
      alt: 'Special event',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/785_1748814909.mp4',
      alt: 'Hibachi experience',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/786_1748814934.mp4',
      alt: 'Group celebration',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/787_1748814974.mp4',
      alt: 'Family dinner',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/788_1748814998.mp4',
      alt: 'Special occasions',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/801_1749206859.mp4',
    ...
    {
      type: 'image',
      src: '/images/moments/8041749493135_.pic.jpg',
      alt: 'Happy guests'
    },
    // New Videos
    {
    ...
    {
      type: 'video',
      src: '/videos/moments/553_1747063222.mp4',
      alt: 'Hibachi performance',
      orientation: 'portrait',
      size: 'large'
    },
    {
      type: 'video',
      src: '/videos/moments/555_1747063240.mp4',
      alt: 'Special event',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/556_1747063241.mp4',
      alt: 'Hibachi experience',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/557_1747063242.mp4',
      alt: 'Group celebration',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/551_1747063204.mp4',
      alt: 'Family dinner',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/549_1747063158.mp4',
      alt: 'Special occasions',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/548_1747061835.mp4',
      alt: 'Corporate events',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/547_1747061831.mp4',
      alt: 'Birthday parties',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/546_1747061828.mp4',
      alt: 'Group dining',
      orientation: 'portrait'
    },
    {
      type: 'video',
      src: '/videos/moments/545_1747061826.mp4',
      alt: 'Hibachi show',
      orientation: 'portrait'
    },
    // Old Videos
